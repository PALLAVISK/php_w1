<?php
    ...
    class Database{
        ...
        public function check($email,$pass){
            ...
            // if($result->num_rows==0){
            //     $roles="admin";
            //     $sql = "INSERT INTO logger(fname, email,password1,roles) VALUES('$name','$email','$hash','$roles')";
            //     $result =($this->conn->query($sql));
            ...
            //     $sql = "INSERT INTO logger(fname, email,password1,roles) VALUES('$name','$email','$hash','$roles')";
            //     $result =($this->conn->query($sql));
            //     return "guest inserted";
            // }
        
            
        }
        public function Added($name,$email,$pass,$roles)
        {
        ...
        public function mailer($email,$hash)
        {
            ...
            try {
                ...
                $mail->Port = 587;     
                $mail->timeout=360;                             // TCP port to connect to
